...
class BlackJack {
  ...
  public static void main(String[] args) {
    ...
    System.out.println();
      ...
      String[] player = new String[HAND_SIZE]; String[] dealer = new
      String[HAND_SIZE];
      
      int bet = setup(scn, dealer, player);
      
      // player plays... inPlay(scn, player, false); // dealer plays... inPlay(scn,
      dealer, true);
  ...
  // This makes the tests work. public static void useTest(Scanner scn) {
  System.out.println("Want to use a test deck?");System.out.print("(0:looser 1:winner or skip): ");
...
// These are the test decks. static final String[][] DECK_TESTS = { { "♥3",
"♥A","♥9","♠4","♣4","♥4","♥5","♦4","♠2","♥Q","♣8","♠K","♦2","♥2","♣J","♦5","♣2","♥K","♠J","♥10","♠3","♣3","♣K","♦3","♦A","♦K","♥7","♥8","♦7","♦J","♦8","♦Q","♠6","♣5","♠10","♠8","♥6","♣10","♥J","♠9","♣9","♦9","♦6","♠A","♠Q","♣A","♣Q","♦10","♣7","♠7","♣6","♠5"},{"♣J","♥2","♣2","♥A","♣9","♠6","♥4","♥3","♦K","♠5","♥K","♦2","♠7","♥10","♣8","♥6","♠A","♦3","♠3","♦4","♣3","♣A","♥8","♦6","♦A","♠J","♦8","♠8","♥Q","♦5","♠2","♠4","♠10","♣7","♦7","♣Q","♠K","♠Q","♦10","♣5","♦Q","♣4","♣10","♥J","♥5","♦J","♦9","♥9","♥7","♣K","♠9","♣6"}};
